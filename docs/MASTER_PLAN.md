...
| **3 Pantry core** | Units + conversions, products, barcodes, lots, RPCs (purchase/consume/open/transfer/inventory/undo), stock overview, product page, journal | Grocy import done; stock value is sane; FEFO consume works across 2 lots |
